 ...
 */
public class CommandModification extends Command {
    ...
    /**
     * Constructs a CommandModification by parsing the index and optional arguments.
     *
     ...
     */
    public CommandModification(String arguments) throws TradeLogException {
    ...
    public void execute(TradeList tradeList, Ui ui, Storage storage) {
        try {
            if (targetIndex < 0 || targetIndex >= tradeList.getSize()) {
